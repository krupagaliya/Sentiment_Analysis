...
#(derived mean sentiment intensity rating increase for booster words)
B_INCR = 0.293
B_DECR = -0.293

#(derived mean sentiment intensity rating increase for using
...
SPECIAL_CASE_IDIOMS = {"yeah right": -2}
...
class SentiText(object):
    ...
    def _words_and_emoticons(self):
        ...
        Leaves contractions and most emoticons
            not preserve punc-plus-letter emoticons (e.g. :D)
        """
